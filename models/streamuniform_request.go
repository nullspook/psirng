...
type StreamUniformRequest struct {
	ChunkSize *uint32  `schema:"chunk_size" validate:"required,gte=1,lte=65536"`
	Min       *float64 `schema:"min" validate:"required,ltfield=Max"`
	Max       *float64 `schema:"max" validate:"required,gtfield=Min"`
}
